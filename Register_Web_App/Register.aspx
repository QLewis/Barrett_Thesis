...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %>.</h2>
    <h3>This is the cash register</h3>

    <div>
        <!-- Labels above listview-->
        <asp:Label ID="MealLabel" runat="server" Text="Meal"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="barretLabel" runat="server" Text="Barret Label"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="TimeLabel" runat="server" Text="TimeStamp"></asp:Label>
        
        <br>
        <asp:XmlDataSource ID="Students" DataFile="Students.xml" runat="server"></asp:XmlDataSource>
        
        <asp:ListView ID="searchResults" DataSourceID="Students" ItemContainerID="DataSection" runat="server">
            <LayoutTemplate>
        ...
        <!--<asp:XmlDataSource ID="Students" runat="server" DataFile="~/Students.xml"></asp:XmlDataSource>-->
        Student:
